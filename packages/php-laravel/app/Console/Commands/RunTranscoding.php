...
class RunTranscoding extends Command
{
     ...
     * @var string
     */
    protected $signature = 'transcode:run {job_id} {input_key} {output_prefix}';
     ...
     * @var string
     */
    protected $description = 'Download source video from R2, transcode it to HLS, and upload segments back to R2.';
    ...
    public function handle(): int
    {
        ...
        $inputKey = (string) $this->argument('input_key');
        $outputPrefix = (string) $this->argument('output_prefix');
        ...
        try {
            ...
            $this->info("Downloading source file from R2...");
            ...
            $this->info("Uploading output files to R2...");
