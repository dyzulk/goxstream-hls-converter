...
> [!NOTE]
> **Goxstream Role**: Within this workspace, this package serves as the Cloudflare Workers Containers orchestrator.
> It receives transcoding triggers and routes them to container instances executing the FFmpeg transcode pipeline.
> Following the Decoupled Factory Architecture, this worker has no direct storage bindings (e.g. `ANIME_BUCKET` is removed) and routes inputs and outputs via standard HTTP GET/PUT proxied URLs.
